// Program to move the robot according to line position, as well as to pick and place a golf ball (LOCATION 4)`
...
void dropoff()
{
  ...
  else if (SConLine && SRonLine && SLonLine) //T intersection, move right and stop
  {
    digitalWrite(motorpinLF, HIGH);
    digitalWrite(motorpinRF, LOW);
    delay(900);
