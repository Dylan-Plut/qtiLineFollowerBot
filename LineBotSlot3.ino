// Program to move the robot according to line position, as well as to pick and place a golf ball (LOCATION 3)
...
void smartPickup()
{
  ...
  while (!(SConLine && SRonLine && SLonLine))
  {
    ...
    digitalWrite(motorpinRF, LOW); // Tank Turn Right
  }
...
void lineup()
{
  ...
  while (!droppedoff)
  {
    ...
    else if (SConLine && !SRonLine &&SLonLine) //left turn, lining up phase 3 
    {
      digitalWrite(motorpinRF, HIGH);
      digitalWrite(motorpinLF, LOW);
      delay(650);
